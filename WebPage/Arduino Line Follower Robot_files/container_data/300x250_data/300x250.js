...
(lib._300x250 = function(mode,startPosition,loop) {
	...
	this.clickthrough_btn.setTransform(150,125,0.412,2.778,0,0,0,364,45);
	...
	// border
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#B48704").ss(2,1,1).p("A3bzhMAu3AAAMAAAAnDMgu3AAAg");
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(149).to({_off:false},10).wait(80).to({startPosition:0},0).to({alpha:0},10).wait(1));
	...
	this.instance_7.setTransform(150,125,1.875,0.417);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.instance_8 = new lib.Tween8("synched",0);
	this.instance_8.parent = this;
	this.instance_8.setTransform(150,125,1.875,0.417);
